  ...
  return (
    <div className="bg-white min-h-screen pb-28 relative">
      ...
      <div className="bg-white text-gray-900 p-6 pt-5 relative">
        ...
        {/* View toggle */}
        <div className="bg-gray-100 backdrop-blur-sm p-1 rounded-2xl flex mb-5">
          <button
            className={`flex-1 py-2 rounded-xl flex items-center justify-center font-medium text-sm ${
              activeView === "discover"
